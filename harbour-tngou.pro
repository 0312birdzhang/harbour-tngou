...
TARGET = harbour-tngou

CONFIG += sailfishapp

QT += dbus

SOURCES += src/harbour-tngou.cpp

OTHER_FILES += qml/harbour-tngou.qml \
    qml/cover/CoverPage.qml \
    qml/pages/FirstPage.qml \
    rpm/harbour-tngou.spec \
    rpm/harbour-tngou.yaml \
    translations/*.ts \
    harbour-tngou.desktop \
...
TRANSLATIONS += translations/harbour-tngou-de.ts \
                translations/harbour-tngou-zh_CN.ts
